...
import 'package:clubhouse/widget/room_user_profile_.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(CupertinoIcons.doc, size: 30, color: Colors.black),
            onPressed: () {},
          ),
          GestureDetector(
            onTap: () {},
